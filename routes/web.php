...
Route::get("/register", [HealthModulesController::class, 'register'])->name('applicant_registration');
    ...
    Route::middleware([
        ...
        Route::group(['prefix' => 'applicant'], function() {
            ...
            Route::get("/sanitary_permit", [HealthModulesController::class, 'sanitary_permit'])->name('sanitary_permit');
    ...
    Route::group(['prefix' => 'business'], function() {
        Route::group(['prefix' => 'processing'], function() {
            Route::get("/application", [SanitaryModulesController::class, 'processing_application'])->name('processing_application');
