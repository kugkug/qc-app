        ...
        <div class="card-body">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="complaintaddress" placeholder="Enter Business Address" name="complaintaddress">
                  </div>
        
                    <div class="form-group">
                        <label for="specificbrgy"><b>Specific Barangay/Street:</b></label>
                        <input type="text" class="form-control" id="specificbrgy" placeholder="Enter Specific Barangay/Street" name="specificbrgy">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="subject" name="subject" class="form-control" placeholder="Enter your complaint details......." style="height:200px"></textarea>
                    </div>
